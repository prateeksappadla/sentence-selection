...
# Training Parameters
tf.flags.DEFINE_integer("hidden_size", 32, "RNN hidden size")
...
tf.flags.DEFINE_integer("evaluate_every", 25000, "Evaluate model on dev set after this many steps (default: 100)")
...
context_dict = pickle.load(open("data/context_dict_100d.p", "rb"))
question_dict = pickle.load(open("data/question_dict_100d.p", "rb"))
answer_dict = pickle.load(open("data/answer_dict_100d.p", "rb"))

dev_context_dict = pickle.load(open("data/dev_context_dict_100d.p", "rb"))
dev_question_dict = pickle.load(open("data/dev_question_dict_100d.p", "rb"))
dev_answer_dict = pickle.load(open("data/ev_answer_dict_100d.p", "rb"))

embedding_matrix = np.load("data/embedding_matrix_100d.npy")
    ...
    with sess.as_default():
        ...
        def train_step(context, question, answer, verbose=False):
            ...
            _, step, summaries, loss, accuracy = sess.run(
                [train_op, global_step, train_summary_op, sent_classifier.loss, sent_classifier.accuracy],
                feed_dict)
...
# End of error analysis function
        ...
        # dev_batches = data_utils.batch_iter(dev_context_dict, dev_question_dict, dev_answer_dict, num_epochs=1, batch_size=10570)
        # print("\nEvaluation:")
        # for dev_context, dev_question, dev_answer in dev_batches:
        #     dev_step(dev_context, dev_question, dev_answer, writer=dev_summary_writer)    
